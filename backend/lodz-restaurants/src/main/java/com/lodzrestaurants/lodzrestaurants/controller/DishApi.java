...
public class DishApi {
    ...
    @Schema(name = "Add Dish", description = "Add a new dish")
    @PostMapping("/{menuId}")
    public ResponseEntity<DishDto> addDish(@PathVariable Long menuId, @RequestBody DishDto dishDto) {
        DishDto createdDish = dishService.addDish(menuId, dishDto);
